...
enum TGA_TYPE {
    ...
    TGA_UNCOMPRESSED_PALETTE = 1,   // Uncompressed color-mapped image
    TGA_UNCOMPRESSED_RGB = 2,       // Uncompressed true-color image
    TGA_UNCOMPRESSED_MONOCHROME = 3,// Uncompressed black-and-white (grayscale) image

    /* Run-length encoded formats */
    TGA_RLE_PALETTE = 9,            // Run-length encoded color-mapped image
    TGA_RLE_RGB = 10,               // Run-length encoded true-color image
